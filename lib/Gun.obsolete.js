...
(function () {
  ...
  root = root || {};
  var console = root.console = root.console || { log: function log() {} };
  ...
  require(function (module) {
    ...
    Type.obj.copy = function (o) {
      ...
      return !o ? o : JSON.parse((0, _stringify2.default)(o)); // is shockingly faster than anything else, and our data has to be a subset of JSON anyways!
    };(function () {
      function empty(v, i) {
        var n = this.n;
      ...
      Type.obj.map = function (l, c, _) {
        var u,
            ...
            f = fn_is(c);
        t.r = null;
        if (_keys2.default && obj_is(l)) {
          ll = (0, _keys2.default)(l);lle = true;
        }
        if (list_is(l) || ll) {
          x = (ll || l).length;
          for (; i < x; i++) {
    ...
    Act.chain.stun = function () {
      ...
      var resume = function resume() {
        ...
        */
        ...
        _this.ctx.on(_this.tag, args, on.end, on.as, _this);
      };
      this.tmp.halt = 1;
      return resume;
    };
  ...
  require(function (module) {
    ...
    var Graph = {}(function () {
      ...
      Graph.ify = function (obj, env, as) {
        ...
        if (env.soul) at.rel = Val.rel.ify(env.soul);
        env.graph = env.graph || {};
        env.seen = env.seen || [];
        env.as = env.as || as;
        node(env, at);
    ...
    Graph.node = function (node) {
      ...
      function map(v, f) {
        ...
        var obj = void 0;
        if (Node._ === f) {
          if (obj_empty(v, Val.rel._)) return;
    ...
    Gun.chain.toJSON = function () {}(function () {
      ...
      Gun.chain.opt = function (opt) {
        ...
        if (list_is(opt.peers)) {
          opt.peers = obj_map(opt.peers, function (n, f, m) {
            m(n, {});
          });
        }
    ...
    module.exports = Gun(function () {
      ...
      function map(value, field) {
        ...
        var iv = rel_is(value) || value,
            cv = rel_is(vertex[field]) || vertex[field];
  ...
  require(function (module) {
    ...
    var _soul = Gun.val.rel._,
      ...
      Gun.chain.put = function (data, cb, opt, as) {
        ...
        if (root === gun || as.soul) {
          if (!obj_is(as.data)) {
            (opt.any || noop).call(opt.as || gun, as.out = { err: Gun.log('No field to put', (0, _typeof3.default)(as.data), '"' + as.data + '" on!') });
            if (as.res) {
              as.res();
            }
            return gun;
  ...
  require(function (module) {
    if (typeof JSON === 'undefined') {
      throw new Error('Include JSON first: ajax.cdnjs.com/ajax/libs/json2/20110223/json2.js');
    } // for old IE use
  ...
  require(function (module) {
    ...
    r.ws = function (opt, cb, req) {
      ...
      if (ws = r.ws.peers[opt.base]) {
        ...
        ws.sending = true;
        ws.send((0, _stringify2.default)(req));
        return true;
      }
      if (ws === false) {
        return;
      ...
      ws.onmessage = function (m) {
        ...
        if (res.headers['ws-rid']) {
          return (ws.cbs[res.headers['ws-rid']] || function () {})(null, res);
        }
        if (res.body) {
          r.createServer.ing(res, function (res) {
            res.out = true;r(opt.base, null, null, res);
          });
        } // emit extra events.
      };
    ...
    r.jsonp.ify = function (opt, cb) {
      ...
      if (opt.headers) {
        q += uri('`') + '=' + uri((0, _stringify2.default)(opt.headers)) + '&';
      }
  ...
  require(function (module) {
    ...
    if (typeof Gun === 'undefined') {
      return;
    } // TODO: window.Websocket is Browser only. But it would be nice if it could somehow merge it with lib/WSP?
