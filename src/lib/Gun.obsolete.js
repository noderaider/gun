...
(function(){
  ...
  require(function(module){
    ...
    (function(){
      ...
      function map(s, f) {
        ...
        if(o.id)
          return o.id = false // if ID is already defined AND we're still looping through the object, it is considered invalid.
  ...
  require(function(module){
    ...
    (function(){
      ...
      function map(v, f) {
        let o = this.opt, tmp, u // iterate over each field/value.
        if(o.map){
